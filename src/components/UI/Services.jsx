...
const Services = () => {
    return (
        <section id="services" className="bg-[#f7fff7] dark:bg-black">
                    ...
                    <div className="w-full py-3 sm:max-w-xl sm:mx-auto sm:px-0">
                            ...
                            <div className="flex items-center flex-col sm:flex-row">
                                ...
                                <div className="flex justify-start w-full mx-auto items-center">
                                    <div className="w-full sm:w-1/2 sm:pr-8">
                                        <div data-aos="fade-right" dat-aos-duration="1200" className="bg-[#f7fff7] dark:bg-black hover:dark:bg-primaryColor p-4 rounded shadow group hover:bg-primaryColor cursor-pointer ease-in duration-150">
                            ...
                            <div className="flex items-center flex-col sm:flex-row">
                                ...
                                <div className="flex justify-end w-full mx-auto items-center">
                                    <div className="w-full sm:w-1/2 sm:pl-8">
                                        <div data-aos="fade-left" dat-aos-duration="1300" data-aos-delay="50" className="bg-[#f7fff7] dark:bg-black hover:dark:bg-primaryColor p-4 rounded shadow group hover:bg-primaryColor cursor-pointer ease-in duration-150">
                        ...
                        <div className="mt-6 sm:mt-0 sm:mb-12">
                            <div className="flex items-center flex-col sm:flex-row">
                                ...
                                <div className="flex justify-start w-full mx-auto items-center">
                                    <div className="w-full sm:w-1/2 sm:pr-8">
                                        <div data-aos="fade-right" dat-aos-duration="1400" data-aos-delay="100" className="bg-[#f7fff7] dark:bg-black p-4 rounded shadow group hover:bg-primaryColor dark:hover:bg-primaryColor cursor-pointer ease-in duration-150">
